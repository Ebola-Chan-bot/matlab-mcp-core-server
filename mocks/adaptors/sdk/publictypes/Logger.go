...
func (_mock *MockLogger) With(key string, value any) publictypes.Logger {
	...
	if returnFunc, ok := ret.Get(0).(func(string, any) publictypes.Logger); ok {
...
func (_c *MockLogger_With_Call) Return(logger publictypes.Logger) *MockLogger_With_Call {
	_c.Call.Return(logger)
	return _c
}

func (_c *MockLogger_With_Call) RunAndReturn(run func(key string, value any) publictypes.Logger) *MockLogger_With_Call {
	_c.Call.Return(run)
	return _c
}

// WithError provides a mock function for the type MockLogger
func (_mock *MockLogger) WithError(err error) publictypes.Logger {
	...
	var r0 publictypes.Logger
	if returnFunc, ok := ret.Get(0).(func(error) publictypes.Logger); ok {
		r0 = returnFunc(err)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(publictypes.Logger)
...
func (_c *MockLogger_WithError_Call) Return(logger publictypes.Logger) *MockLogger_WithError_Call {
	_c.Call.Return(logger)
	return _c
}

func (_c *MockLogger_WithError_Call) RunAndReturn(run func(err error) publictypes.Logger) *MockLogger_WithError_Call {
	_c.Call.Return(run)
	return _c
}
