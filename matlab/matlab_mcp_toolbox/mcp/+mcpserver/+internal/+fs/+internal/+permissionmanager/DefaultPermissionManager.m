classdef DefaultPermissionManager < mcpserver.internal.fs.internal.permissionmanager.PermissionManager
    ...
    methods
        function obj = DefaultPermissionManager(options)
            arguments
                options.?mcpserver.internal.fs.internal.permissionmanager.DefaultPermissionManager
            end
