classdef DefaultAPIKeyManager < mcpserver.internal.connector.internal.apikeymanager.APIKeyManager
    ...
    properties (GetAccess = private, SetAccess = immutable)
        ...
        MATLABFacade(1, 1) mcpserver.internal.facade.matlab.MATLABFacade = mcpserver.internal.facade.matlab.DefaultMATLABFacade()
        SecureGenerator(1, 1) mcpserver.internal.connector.internal.apikeymanager.internal.securegen.SecureGenerator = mcpserver.internal.connector.internal.apikeymanager.internal.securegen.DefaultSecureGenerator()
    end

    methods
        function obj = DefaultAPIKeyManager(options)
            arguments
                options.?mcpserver.internal.connector.internal.apikeymanager.DefaultAPIKeyManager
            end
