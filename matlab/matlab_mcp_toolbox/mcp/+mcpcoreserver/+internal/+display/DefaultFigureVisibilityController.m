classdef DefaultFigureVisibilityController < mcpcoreserver.internal.display.FigureVisibilityController
    ...
    properties (GetAccess = private, SetAccess = immutable)
        DisplayFacade(1, 1) mcpcoreserver.internal.facade.display.DisplayFacade = mcpcoreserver.internal.facade.display.DefaultDisplayFacade()
    end
    ...
    methods
        function obj = DefaultFigureVisibilityController(options)
            arguments
                options.?mcpcoreserver.internal.display.DefaultFigureVisibilityController
            end
