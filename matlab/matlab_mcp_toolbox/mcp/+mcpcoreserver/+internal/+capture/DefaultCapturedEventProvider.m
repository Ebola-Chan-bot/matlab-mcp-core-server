classdef DefaultCapturedEventProvider < mcpcoreserver.internal.capture.CapturedEventProvider
    %DefaultCapturedEventProvider Implementation using MATLAB internal EventsCollector

    % Copyright 2026 The MathWorks, Inc.

    properties (GetAccess = private, SetAccess = immutable)
        Factory(1, 1) mcpcoreserver.internal.facade.capture.CollectorFactoryFacade = mcpcoreserver.internal.facade.capture.DefaultCollectorFactoryFacade()
    end
    ...
    methods
        function obj = DefaultCapturedEventProvider(options)
            arguments
                options.?mcpcoreserver.internal.capture.DefaultCapturedEventProvider
            end
