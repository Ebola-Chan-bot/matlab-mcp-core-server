classdef CoreDotNetAccessControl < handle & mcpcoreserver.internal.fs.internal.permissionmanager.internal.windowsacl.internal.dotnet.DotNetAccessControl
    ...
    methods
        function obj = CoreDotNetAccessControl(options)
            arguments
                options.?mcpcoreserver.internal.fs.internal.permissionmanager.internal.windowsacl.internal.dotnet.CoreDotNetAccessControl
            end
    ...
    methods (Access = private)
        function ensureAssemblyLoaded(obj)
            ...
            try
                ...
                err = mcpcoreserver.internal.error.Errors.FailedToLoadDotNetAssembly(obj.AssemblyName);
